...
import type { Schema, Catalog, Item, RuleSet, ClusterRuleSet, ComparisonResult } from '$lib/api/client';
 ...
 */
export function createMockClusterRuleSet(overrides?: Partial<ClusterRuleSet>): ClusterRuleSet {
