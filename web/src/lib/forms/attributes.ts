 ...
 */
export function getListValueAsString(attributes: Record<string, any>, key: string): string {
 ...
 */
export function initializeAttributes(dimensions: Dimension[]): Record<string, any> {
