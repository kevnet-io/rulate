...
describe('Navigation Component', () => {
	describe('Navigation Items', () => {
		...
		it('includes cluster-rulesets link', () => {
			expect(navItems).toContainEqual({ href: '/cluster-rulesets', label: 'Cluster RuleSets' });
		});
		...
		it('includes import-export link', () => {
			expect(navItems).toContainEqual({ href: '/import-export', label: 'Import/Export' });
		});
	});
	...
	describe('Active Route Detection', () => {
		...
		describe('Cluster RuleSets route', () => {
			...
			it('marks cluster-rulesets as active on nested cluster ruleset routes', () => {
				expect(isActive('/cluster-rulesets', '/cluster-rulesets/test')).toBe(true);
			});
