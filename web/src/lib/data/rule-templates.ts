...
export const RULE_TEMPLATES: RuleTemplate[] = [
	...
	},
	{
		...
		description: 'Items with the same value in one field must differ in another',
		category: 'exclusion',
		condition: {
			all: [
				{
...
export const WARDROBE_TEMPLATES: RuleTemplate[] = [
	...
	},
	{
		...
		description: 'Outfit must cover different body zones with consistent formality',
		category: 'requirement',
		condition: {
			all: [
				{
...
export function getTemplatesByType(type: 'pairwise' | 'cluster'): RuleTemplate[] {
