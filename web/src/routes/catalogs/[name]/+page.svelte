...
<div class="container mx-auto px-4 py-8">
	<div class="mb-6">
		<Button href="/catalogs" variant="ghost" size="sm">← Back to Catalogs</Button>
	</div>
				...
				<CardContent>
					{#if items.length === 0}
						<div class="text-center py-8">
							<p class="text-muted-foreground mb-4">No items in this catalog yet</p>
							<Button href="/catalogs/{catalogName}/items/new">Add First Item</Button>
						</div>
					{:else}
								...
								<div class="border rounded-lg p-4">
									<div class="flex items-start justify-between mb-2">
										<div class="flex-1">
											...
											<p class="text-xs text-muted-foreground">{item.item_id}</p>
										</div>
									</div>

									<div class="mt-3 space-y-1">
										<p class="text-xs font-medium text-muted-foreground mb-1">Attributes:</p>
