...
import { createMockCatalog, createMockSchema, createMockItem } from '$lib/test-utils/fixtures';
...
describe('Item Creation Form (+page)', () => {
	...
	describe('Type Conversion - String', () => {
		...
		it('trims whitespace from string input', () => {
			const dim: Dimension = { name: 'description', type: 'string', required: false };
	...
	describe('Type Conversion - Integer', () => {
		it('converts string to integer', () => {
			const dim: Dimension = { name: 'count', type: 'integer', required: false };
		...
		it('parses negative integers', () => {
			const dim: Dimension = { name: 'delta', type: 'integer', required: false };
	...
	describe('Type Conversion - Boolean', () => {
		it('stores boolean true', () => {
			const dim: Dimension = { name: 'washable', type: 'boolean', required: false };
		...
		it('toggles boolean value', () => {
			const dim: Dimension = { name: 'reversible', type: 'boolean', required: false };
			let attributes = { reversible: false };
	...
	describe('Form Validation', () => {
		...
		it('validates required dimensions', () => {
			...
			let attributes = initializeFormState(schema);
	...
	describe('Form Submission', () => {
		it('calls createItem API with correct data', async () => {
			...
			const result = await api.api.createItem('TestCat', {
				item_id: 'item1',
				name: 'Test Item',
				attributes: { color: 'blue' }
			});
	...
	describe('Error Handling', () => {
		...
		it('displays error message on form', () => {
			let error: string | null = 'Failed to create item';
