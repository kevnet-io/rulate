...
<div class="container mx-auto px-4 py-8 max-w-7xl">
  <div class="mb-8">
    ...
    <p class="text-muted-foreground">
      Create a collection of items to evaluate
    </p>
  </div>
  ...
  {:else if schemas.length === 0}
    <Card class="border-destructive">
      <CardHeader>
        ...
        <CardDescription
          >You need to create a schema before creating a catalog</CardDescription
        >
      </CardHeader>
      <CardContent>
    ...
    <form onsubmit={handleSubmit}>
      <div class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <p class="text-xs text-muted-foreground mt-1">
                  Items in this catalog will be validated against the selected
                  schema
                </p>
              </div>
              <div>
        ...
        <Card>
          ...
          <CardContent>
            <p class="text-sm text-muted-foreground">
              After creating the catalog, you'll be able to add items to it from
        ...
        <div class="flex gap-3">
          ...
          <Button type="button" variant="outline" href="/catalogs"
            >Cancel</Button
          >
        </div>
      </div>
