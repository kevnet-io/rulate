<script lang="ts">
  ...
  const selectedSchema = $derived(() =>
    schemas.find((s) => s.name === schema_name),
  );
  ...
  {:else if schemas.length === 0}
    <Card class="border-destructive">
      <CardHeader>
        ...
        <CardDescription
          >You need to create a schema before creating a ruleset</CardDescription
        >
      </CardHeader>
      <CardContent>
    ...
    <form onsubmit={handleSubmit}>
      <div class="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <div class="space-y-4">
              ...
              <div>
                <label for="schema" class="block text-sm font-medium mb-2"
                  >Schema</label
                >
                <select
                  id="schema"
                ...
                >
                  {#each schemas as schema}
                    <option value={schema.name}
                      >{schema.name} (v{schema.version})</option
                    >
                  {/each}
                </select>
              </div>
          ...
          <CardHeader>
            <div class="flex items-start justify-between">
              <div>
                ...
                <CardDescription
                  >Define exclusion and requirement rules</CardDescription
                >
              </div>
                    ...
                    <div class="space-y-4">
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center gap-2">
                          ...
                          <label
                            for="enabled-{index}"
                            class="text-sm font-medium">Enabled</label
                          >
                        </div>
                      </div>
        ...
        <div class="flex gap-3">
          ...
          <Button type="button" variant="outline" href="/rulesets"
            >Cancel</Button
          >
        </div>
      </div>
