...
<div class="container mx-auto px-4 py-8">
  <div class="mb-8">
    ...
    <p class="text-muted-foreground">
      Visualize compatibility between all items in a catalog
    </p>
  </div>
  ...
  <div class="space-y-6">
    <Card>
      <CardHeader>
        ...
        <CardDescription
          >Select a catalog and ruleset to evaluate</CardDescription
        >
      </CardHeader>
      <CardContent>
        ...
        <CardContent>
            ...
            <table class="w-full border-collapse">
              <thead>
                <tr>
                  ...
                  {#each items as item}
                    <th
                      class="border p-2 bg-muted text-xs font-medium min-w-[100px] max-w-[150px]"
                    >
                  ...
                  <tr>
                    ...
                    {#each items as item2}
                      ...
                      <td
                        ...
                        class:bg-rose-50={result &&
                          !result.compatible &&
                          !isSame}
                        class:text-rose-700={result &&
                          !result.compatible &&
                          !isSame}
                        onclick={() => {
          ...
          <div class="mt-4 flex items-center gap-4 text-sm">
            <div class="flex items-center gap-2">
              <div
                class="w-5 h-5 bg-emerald-50 border border-emerald-200 rounded flex items-center justify-center"
              >
            ...
            <div class="flex items-center gap-2">
              <div
                class="w-5 h-5 bg-rose-50 border border-rose-200 rounded flex items-center justify-center"
              >
            ...
            <div class="flex items-center gap-2">
              <div
                class="w-5 h-5 bg-muted border rounded flex items-center justify-center"
              >
      ...
      <Card>
        <CardHeader>
          <div class="flex items-start justify-between">
            ...
            <Badge
              variant={selectedPair.compatible ? "default" : "destructive"}
            >
